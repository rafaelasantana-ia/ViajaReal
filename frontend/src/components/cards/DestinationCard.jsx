...
import { destinationDetailsPath } from '../../services/destinationSearchService';

export function DestinationCard({ destination }) {
  return (
    <Link to={destinationDetailsPath(destination)} className="relative h-28 min-w-24 overflow-hidden rounded-xl shadow-card">
